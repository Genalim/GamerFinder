...
class _ChoosePlatformScreenState extends State<ChoosePlatformScreen> {
      ...
      body: SafeArea(
        child: Stack(
          children: [
            Column(
              children: [
                _buildAppBar('Choose your platforms'),
                Expanded(
                        ...
                        Wrap(
                          ...
                          children: _platforms.map((platform) {
                            ...
                            return _buildPlatformCard(
                                platform, isSelected, accentColor);
                          }).toList(),
                        ),
                      ],
                    ),
  ...
  Widget _buildPlatformCard(Map<String, String> platform, bool isSelected,
      Color accentColor) {
        ...
        onTap: () {
          if (_selectedPlatforms.isNotEmpty) {
            ...
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => const PlayStyleScreen(),
              ),
            );
          }
        },
